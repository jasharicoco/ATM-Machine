...
namespace Bankomat
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            decimal[,] accounts = {
                    { 1000, 2000, 3000 }, // Saldo för user1
    { 1500, 2500, 3500 }, // Saldo för user2
    { 1200, 2200, 3200 }, // Saldo för user3
    { 1300, 2300, 3300 }, // Saldo för user4
    { 1400, 2400, 3400 }  // Saldo för user5
            };
